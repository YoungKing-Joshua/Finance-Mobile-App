import '../home_five_screen/widgets/transactiondeta_item_widget.dart';
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => ListView.separated(
                      ...
                      itemCount: controller.homeFiveModelObj.value
                          .transactiondetaItemList.value.length,
                      itemBuilder: (context, index) {
                        TransactiondetaItemModel model = controller
                            .homeFiveModelObj
                            .value
                            .transactiondetaItemList
                            .value[index];
                        return TransactiondetaItemWidget(
                          model,
                        );
                      },
                    ),
