...
class Transactiondeta1ItemWidget extends StatelessWidget {
  Transactiondeta1ItemWidget(
    this.transactiondeta1ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Transactiondeta1ItemModel transactiondeta1ItemModelObj;
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Obx(
                        () => Text(
                          transactiondeta1ItemModelObj.amountTxt.value,
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => Text(
                        transactiondeta1ItemModelObj.giftTagTxt.value,
