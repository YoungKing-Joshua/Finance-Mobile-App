import '../home_ten_screen/widgets/transactiondeta4_item_widget.dart';
import 'controller/home_ten_controller.dart';
import 'models/transactiondeta4_item_model.dart';
...
class HomeTenScreen extends GetWidget<HomeTenController> {
  const HomeTenScreen({Key? key})
      : super(
          key: key,
        );
                ...
                child: Padding(
                  ...
                  child: Obx(
                    () => ListView.separated(
                      ...
                      itemCount: controller.homeTenModelObj.value
                          .transactiondeta4ItemList.value.length,
                      itemBuilder: (context, index) {
                        Transactiondeta4ItemModel model = controller
                            .homeTenModelObj
                            .value
                            .transactiondeta4ItemList
                            .value[index];
                        return Transactiondeta4ItemWidget(
                          model,
                        );
                      },
                    ),
